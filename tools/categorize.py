...
RULES = [
    ...
    ('Programming',    ['code','programming','developer','console','sql','database','api','binary','variable','source-code','inspect-code','step-','property-','software','translate','translation','language-skill','command-line','incognito','message-programming','web-design','web-programming','regex','terminal']),
    ...
    ('Arrows',         ['arrow','circle-arrow','square-arrow','curvy-','scroll-point','unfold-','transition-','move-to','navigation-0']),
    ...
    ('Editing',        ['text-','paragraph','heading','pen-tool','pencil','paint','brush','eraser-','crop','layer','align-','distribute-','pathfinder','stroke-','flip-','rotate','group-','ungroup','magic-wand','lasso','color-picker','colors','swatch','gradient','blur','blend','opacity','transparency','artboard','canvas','bend-tool','join-','cap-','dashed-line','solid-line','edge-style','skew','perspective','anchor-point','select-','selection','quote-','list-view','grid','row-','column-','table-','insert-','left-to-right','right-to-left','letter-spacing','type-cursor','font','italic','bold','underline','strikethrough','superscript','subscript','smallcaps','kerning','tracking','indent','wrap','ruler','scissor','copy-','cut-','paste','undo','redo','refresh','reload','edit-','drawing-','straight-edge','orthogonal','carousel','trapezoid-line','change-screen','character-phonetic','command','covariate','minimize','maximize','resize','move-0','drag-0','signature','stamp-0','ellipse-selection','marquee']),
...
tagged = [[s, n, c, categorize(n)] for s, n, c in ICONS]
